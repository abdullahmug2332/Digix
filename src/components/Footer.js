    ...
    return (
        <div className='footercontainer'>
            <div className="footerup">
                <div className="footer1">
                    <div className='footerlogocon'>
                        <h1 className='footerlogo'>Digix</h1>
                    </div>
                    <div className="infofooter">
                        <p className="addressfooter">6th floor,800/D queens road, lane Pakistan-1782</p>
                ...
                <div className="footer2">
                    ...
                    <p className='footerbooking'>Courses</p>
                    <p className='footercontact'>Fee</p>
                </div>
                <div className="footer3">
                    <h2 className='popularplaces'>Popular Courses</h2>
                    <p className='paris'>Web Development</p>
                    <p className="dubai">Digital Marketing</p>
                    <p className="switzerland">Graphic Designing</p>
                    <p className="maldivess">Artificial Intelligence</p>
                    <p className="borabora">English Spoken</p>
                </div>
            ...
            <div className="footerdown">
                ...
                <p className='copyright'>Copyright © 2023, all right reserved | This template is made by Abdullah </p>
            </div>
        </div>
    )
}
